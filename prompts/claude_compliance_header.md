### ⚠️ Compliance Protocol: MANDATORY
...
- The entry MUST follow this exact format:
  ...
  **SUMMARY:** [A one-sentence summary of your task outcome.]
  **ARTIFACTS:**
  - **CREATED:** [List of files]
  - **MODIFIED:** [List of files]
  - **DELETED:** [List of files]
  - **DB_SCHEMA_CHANGE:** [Description of any database changes]
  **NOTES:** [Any notes for the next agent.]

Failure to follow this protocol will result in a failed task.
---
**Your Task:**
