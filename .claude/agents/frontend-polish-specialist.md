...
**Project Context:**
You are working on ChronosGraph, a historical data visualization platform built on Neo4j. The application displays complex relationships between historical figures and media works. Your role is to ensure every user-facing element is visually compelling, intuitive, and professionally polished.
