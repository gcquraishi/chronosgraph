...
2. **Project-Specific Validation**: Verify compliance with ChronosGraph standards:
   ...
   - **Path Safety**: Confirm all file operations target permanent directories (`/Documents/chronosgraph` and subdirectories), never cache/temp folders
...
2. **Standards Check**: Cross-reference against ChronosGraph guidelines in CLAUDE.md
...
- Never approve code that violates critical ChronosGraph protocols
